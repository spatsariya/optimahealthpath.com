<?php
$pageTitle = "OptimaHealthPath - Leading Teleradiology Services North America & Asia | US, Canada & India";
$pageDescription = "Professional teleradiology services across US, Canada & India. 24/7 remote radiology reporting, AI-assisted diagnostics, PACS integration, and expert radiologists serving North America and Asia healthcare facilities.";
?>
<!DOCTYPE html>
<html lang="en">
<head>
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-19L0C1EPTT"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-19L0C1EPTT');
</script>
    ...
    <meta property="og:url" content="https://optimahealthpath.com">
